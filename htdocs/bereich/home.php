...
<body>
    ...
    <!-- Eigenes, kuerzeres Seitenverhaeltnis nur fuer dieses Foto (971x1191
         statt 971x1619) - oben wegen des leeren Himmels gekuerzt, unten
         zusaetzlich auf Screenshot-Vorgabe (rote Markierung), da dort nur
         noch bildinformationsarme Flaeche (Wechselbox/Wiese) stand. -->
    <div class="home-hero" style="background-image:url('../assets/img/brand/transition-hero.jpg?v=<?= cacheV('assets/img/brand/transition-hero.jpg') ?>'); aspect-ratio: 971 / 1191;">
