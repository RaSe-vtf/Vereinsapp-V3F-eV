...
<body class="seite-mit-hintergrundfoto">
    ...
    <main class="container" style="max-width:1040px;">
        ...
        <div class="seiten-footer-foto" style="background-image:url('../../assets/img/brand/footer-mitglieder.jpg?v=<?= cacheV('assets/img/brand/footer-mitglieder.jpg') ?>');" aria-hidden="true"></div>
    </main>
