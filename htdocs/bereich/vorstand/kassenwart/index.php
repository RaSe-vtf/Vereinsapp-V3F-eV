...
<body class="seite-mit-hintergrundfoto">
    ...
    <main class="container" style="max-width:1040px;">
        ...
        <div class="seiten-footer-foto" style="background-image:url('../../../assets/img/brand/footer-kassenwart.jpg?v=<?= cacheV('assets/img/brand/footer-kassenwart.jpg') ?>');" aria-hidden="true"></div>
    </main>
