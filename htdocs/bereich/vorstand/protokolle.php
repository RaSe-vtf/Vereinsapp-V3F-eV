...
<body class="seite-mit-hintergrundfoto">
    ...
    <main class="container" style="max-width:1040px;">
        ...
        <div class="seiten-footer-foto" style="background-image:url('../../assets/img/brand/footer-protokolle.jpg?v=<?= cacheV('assets/img/brand/footer-protokolle.jpg') ?>');" aria-hidden="true"></div>
    </main>
