 ...
 * Home-Button, Zurück-Pfeil und Menü-Symbol nebeneinander im Banner.
 *
...
<header class="top-header">
    <div class="top-header__inner">
        ...
        <?php if ($zurueck !== null): ?>
            <a class="top-header__back" href="<?= e($zurueck) ?>" aria-label="Zurück" title="Zurück">
        ...
        <?php endif; ?>
        <div class="menu-wrapper"<?= $zurueck !== null ? ' style="margin-left:8px;"' : '' ?>>
